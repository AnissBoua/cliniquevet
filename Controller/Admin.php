...
class Admin extends Blog
{
    ...
    public function edit()
    {
      ...
      $this->oUtil->idAnimal = $this->oModel->getAnimalAll();
    ...
    public function editPost()
    {
      ...
      $this->oUtil->idAnimal = $this->oModel->getAnimalById($_GET['id']);
    ...
    public function add()
    {
      ...
      {
          if (empty($_POST['animalname']) || empty($_POST['birthdate']))
          {
            $this->oUtil->sErrMsg = 'Tous les champs doivent être remplis.';
          }
          else
          {
            ...
            $aData = array('animalname' => $_POST['animalname'], 'birthdate' => $_POST['birthdate']);
