      ...
      <div class="card-panel">
        ...
        <form method="post">
          <div class="row">
            ...
            <div class="input-field col s12">
              <input type="text" class="black-text" name="pseudo" id="pseudo">
              <label for="pseudo">Pseudo</label>
            </div>
            <div class="input-field col s12">
              <input type="password" class="black-text" id="password" name="password">
              <label for="password">Mot de passe</label>
            </div>
            <div class="input-field col s12">
              <input type="password" class="black-text" name="password_again" id="password_again">
